...
public class RecipeCookRecordController {
    ...
    // 예: POST /api/v1/recipes/1/cook-records?userId=1  (누를 때마다 만듦<->취소 토글)
    ...
    // 예: GET /api/v1/recipes/1/cook-records?userId=1
    ...
    // 예: GET /api/v1/users/me/made-recipes?userId=1
    @GetMapping("/api/v1/users/me/made-recipes")
    public List<MadeRecipeResponse> getMyMadeRecipes(@RequestParam("userId") Long userId) {
