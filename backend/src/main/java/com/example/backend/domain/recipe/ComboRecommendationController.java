...
public class ComboRecommendationController {
    ...
    public List<ComboRecommendResponse> getComboRecommendations(
            @AuthenticationPrincipal Long userId,
            @RequestParam(defaultValue = "false") boolean onlyOwned) {
        return comboRecommendationService.getComboRecommendations(userId, onlyOwned);
    }
}
